 ...
 */
import { getDashboardStats as api_analytics_dashboard_stats_getDashboardStats } from "~backend/analytics/dashboard_stats";
import { getSalesChart as api_analytics_sales_chart_getSalesChart } from "~backend/analytics/sales_chart";
...
export namespace analytics {
    ...
    export class ServiceClient {
         ...
         */
        public async getDashboardStats(params: RequestType<typeof api_analytics_dashboard_stats_getDashboardStats>): Promise<ResponseType<typeof api_analytics_dashboard_stats_getDashboardStats>> {
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_analytics_dashboard_stats_getDashboardStats>
        }

        /**
         * Gets sales data for charting
         */
        public async getSalesChart(params: RequestType<typeof api_analytics_sales_chart_getSalesChart>): Promise<ResponseType<typeof api_analytics_sales_chart_getSalesChart>> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
                endDate:   params.endDate,
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/analytics/sales-chart`, {query, method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_analytics_sales_chart_getSalesChart>
        }
    }
}
...
import { searchByBarcode as api_products_search_by_barcode_searchByBarcode } from "~backend/products/search_by_barcode";
    ...
    export class ServiceClient {
        ...
        public async list(params: RequestType<typeof api_products_list_list>): Promise<ResponseType<typeof api_products_list_list>> {
            ...
            const query = makeRecord<string, string | string[]>({
                ...
                lowStock:   params.lowStock === undefined ? undefined : String(params.lowStock),
         ...
         */
        public async searchByBarcode(params: RequestType<typeof api_products_search_by_barcode_searchByBarcode>): Promise<ResponseType<typeof api_products_search_by_barcode_searchByBarcode>> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/products/search/barcode`, {query, method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_products_search_by_barcode_searchByBarcode>
        }
...
import { getOrder as api_sales_get_order_getOrder } from "~backend/sales/get_order";
...
export namespace sales {
    ...
    export class ServiceClient {
         ...
         */
        public async getOrder(params: { id: number }): Promise<ResponseType<typeof api_sales_get_order_getOrder>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/sales/orders/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_sales_get_order_getOrder>
        }
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { getCurrent as api_users_get_current_getCurrent } from "~backend/users/get_current";
import { sync as api_users_sync_sync } from "~backend/users/sync";
...
export namespace users {
    ...
    export class ServiceClient {
         ...
         */
        public async getCurrent(): Promise<ResponseType<typeof api_users_get_current_getCurrent>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/users/me`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_users_get_current_getCurrent>
        }

        /**
         * Syncs user data from Clerk to the database
         */
        public async sync(params: RequestType<typeof api_users_sync_sync>): Promise<ResponseType<typeof api_users_sync_sync>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/users/sync`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_users_sync_sync>
        }
    }
}
