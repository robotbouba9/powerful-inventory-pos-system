...
```bash
git remote add encore encore://powerful-inventory-pos-system-9cf2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/powerful-inventory-pos-system-9cf2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/powerful-inventory-pos-system-9cf2/settings/integrations/github)
